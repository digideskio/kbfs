...
type folderBlockOps struct {
	...
	deferredWrites []func(context.Context, *lockState, ConstRootMetadata, path) error
...
func (fbo *folderBlockOps) getBlockHelperLocked(ctx context.Context,
	lState *lockState, md ConstRootMetadata, ptr BlockPointer, branch BranchName,
...
func (fbo *folderBlockOps) getFileBlockHelperLocked(ctx context.Context,
	lState *lockState, md ConstRootMetadata, ptr BlockPointer,
...
func (fbo *folderBlockOps) getFileLocked(ctx context.Context,
	lState *lockState, md ConstRootMetadata, file path,
...
func (fbo *folderBlockOps) GetIndirectFileBlockInfos(ctx context.Context,
	lState *lockState, md ConstRootMetadata, file path) ([]BlockInfo, error) {
...
func (fbo *folderBlockOps) getDirLocked(ctx context.Context,
	lState *lockState, md ConstRootMetadata, dir path, rtype blockReqType) (
	*DirBlock, error) {
	fbo.blockLock.AssertAnyLocked(lState)
...
func (fbo *folderBlockOps) GetDir(
	ctx context.Context, lState *lockState, md ConstRootMetadata, dir path,
...
func (fbo *folderBlockOps) getFileBlockAtOffsetLocked(ctx context.Context,
	lState *lockState, md ConstRootMetadata, file path, topBlock *FileBlock,
...
func (fbo *folderBlockOps) getDirtyParentAndEntryLocked(ctx context.Context,
	lState *lockState, md ConstRootMetadata, file path, rtype blockReqType) (
...
func (fbo *folderBlockOps) GetDirtyParentAndEntry(
	ctx context.Context, lState *lockState, md ConstRootMetadata, file path) (
	*DirBlock, DirEntry, error) {
	fbo.blockLock.RLock(lState)
	defer fbo.blockLock.RUnlock(lState)
...
func (fbo *folderBlockOps) getDirtyEntryLocked(ctx context.Context,
	lState *lockState, md ConstRootMetadata, file path) (DirEntry, error) {
...
func (fbo *folderBlockOps) newRightBlockLocked(
	...
	off int64, md ConstRootMetadata) error {
	fbo.blockLock.AssertLocked(lState)
...
func (fbo *folderBlockOps) createIndirectBlockLocked(lState *lockState,
	md ConstRootMetadata, file path, uid keybase1.UID, dver DataVer) (
	*FileBlock, error) {
...
func (fbo *folderBlockOps) Write(
	...
	if fbo.doDeferWrite {
		...
		fbo.deferredWrites = append(fbo.deferredWrites,
			func(ctx context.Context, lState *lockState, rmd ConstRootMetadata, f path) error {
...
func (fbo *folderBlockOps) ReadyBlock(ctx context.Context, md ConstRootMetadata,
...
func (fbo *folderBlockOps) FinishSync(
	ctx context.Context, lState *lockState,
	oldPath, newPath path, md ConstRootMetadata,
...
func (fbo *folderBlockOps) searchForNodesInDirLocked(ctx context.Context,
	...
	md ConstRootMetadata, currDir path, nodeMap map[BlockPointer]Node,
...
func (fbo *folderBlockOps) SearchForNodes(ctx context.Context,
	...
	md ConstRootMetadata) (map[BlockPointer]Node, error) {
