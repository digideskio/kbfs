...
func (fbo *folderBranchOps) getHeadID(lState *lockState) MdID {
	fbo.headLock.RLock(lState)
	defer fbo.headLock.RUnlock(lState)
	return fbo.headID
}
...
func (fbo *folderBranchOps) setHeadLocked(
	...
	fbo.log.CDebugf(ctx, "Setting head revision to %d (id=%s)", md.Revision, headID)
...
func (fbo *folderBranchOps) setHeadSuccessorLocked(ctx context.Context,
	...
	err := fbo.head.CheckValidSuccessor(fbo.headID, md)
	if err != nil {
		return err
	}
...
func (fbo *folderBranchOps) setHeadPredecessorLocked(ctx context.Context,
	...
	err = md.CheckValidSuccessor(mdID, fbo.head)
	if err != nil {
		return err
	}
...
func (fbo *folderBranchOps) finalizeMDWriteLocked(ctx context.Context,
	...
	if doUnmergedPut {
		...
		err := mdops.PutUnmerged(ctx, headID, md, bid)
		if err != nil {
...
func (fbo *folderBranchOps) finalizeMDRekeyWriteLocked(ctx context.Context,
	...
	// finally, write out the new metadata
	err = fbo.config.MDOps().Put(ctx, headID, md)
